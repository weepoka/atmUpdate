...
const SignUp = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await Api.post("/atms/api/v1/student/regi", data)
      console.log("infoRegi:", res.data.data)
      if (res.data.data) {
              ...
              <div className="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
                <div
                  className="flex flex-col items-start justify-start
                   pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl
            relative z-10"
                >
                  <p
                    className="w-full text-4xl font-medium text-center 
                  leading-snug font-serif"
                  >
                    {show ? "Sign up for an account" : "Singup success . Kindly check your email and Verify your eamil"}
                  </p>
                  {show &&
                    <div className="w-full">
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <div className="absolute right-4 top-[12px] cursor-pointer">
                            {!pass ? <p onClick={handlePass} className="text-green-700 font-bold  text-xs">show</p> : <p onClick={handlePass} className="text-green-700 font-bold  text-xs">hide</p>}
                ...
                from-[#0c6f78]  to-[#00f6ff] hover:text-[#000] duration-300  hover:scale-105"
                          >
                            Submit
                          </Button>
                        </div>
...
// }, [course1, unregister]);
{
  /* <div>
              ...
              <Controller
                name="course1"
                control={control}
                rules={{ required: "Course1 is required" }}
                render={({ field }) => (
                  <Select
                    {...field}
                    error={Boolean(errors?.course1?.message)}
                    // disabled={disabled}
                    label="Select Course1"
                  >
                    <Option value="IELTS">Student</Option>
                    <Option value="Spoken & Writing">Spoken & Writing</Option>
                    <Option value="Freelancing">Freelancing</Option>
                    <Option value="others">Others</Option>
                  </Select>
                )}
              />
              {errors?.course1?.message && (
                <span className="text-red-400 text-xs">
                  {errors?.course1?.message}
                </span>
              )}
            ...
            {course1 === "others" && (
              <div>
                <Controller
                  ...
                  control={control}
                  rules={{ required: "othersCourseName is required" }}
                  render={({ field }) => (
                    <Input
                      {...field}
                      error={Boolean(errors?.othersCourseName?.message)}
                      label="Type Here"
                    />
                  )}
                />
                {errors?.othersCourseName?.message && (
                  <span className="text-red-400 text-xs">
                    {errors?.othersCourseName?.message}
                  </span>
                )}
