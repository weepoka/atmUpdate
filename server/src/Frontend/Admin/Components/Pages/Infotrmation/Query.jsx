    ...
    const ContCard = cont && cont?.map((info, i) => (
        <div key={i} className="p-4 w-[300px] shadow-xl rounded-md border  ">
            <div className=' flex justify-between'>
                <p>{info?.senderName}</p>
                <p onClick={() => replayF(info?._id)} className='cursor-pointer font-medium text-green-600 rounded-md shadow-lg bg-[#2a3544]'>Replay Now</p>
            </div>
            ...
            <p>Replay: {info.reply ? <span className='text-cyan-500 ml-2'>Done</span> : <span className='text-orange-700 ml-2'>NO</span>}</p>
            <hr />
               ...
               rounded w-full max-w-xs lg:max-w-lg xl:max-w-xl 2xl:min-w-full"
                        ...
                        <div className=" mb-7 px-5">
                            <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-20">
                                {" "}
                                <div>
                                    <label className="mb-2 md:text-lg  text-gray-400">Replay</label>
                                </div>{" "}
                                <div>
                                    <textarea
                                        type="text"
